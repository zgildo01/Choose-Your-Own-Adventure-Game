...
function getStoryChunks() {
  storyChunks = {

    "begin": {
      "content": `You lay in the infinite void, yet you feel warm and happy; you've achieved such a level of peace that you have never known before, yet, just as you settle in you hear a faint voice. "${playerName}! Are you there? It's dispatch, ${playerName}."`,
      "responses": {
        "a": "Ignore the voice", 
